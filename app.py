...
<style>
    ...
    /* 🔥 التعديل هون (تحويل البوكس لخط فقط) */
    .section-card {
        ...
        border-bottom: 1px solid rgba(255,255,255,0.25); /* 👈 الخط */
    }
...
if not filtered_df.empty:
    ...
    st.warning(" لا يوجد تقرير مطابق للاختيارات الحالية يرجى التواصل على الرقم 101 أو 120.")
